...
- [Python SDK](python-sdk.md)
  ...
  - [Python Toolsets](python/toolsets.md)
  - [Python Models](python/models.md)
  - [Python Structured Output](python/output.md)
  - [Python Sessions and Streams](python/sessions-streams.md)
  - [Python Environments and Skills](python/environments-skills.md)
  - [Python Resources and Media](python/media.md)
  - [Python Testing](python/testing.md)
  - [Python Examples](python/examples.md)
  - [Python Stability and Known Gaps](python/stability.md)
- [Agents](agent.md)
- [Models](models.md)
- [Tools](tools.md)
