...
- `spec/ops/09-rpc-idl-and-client-generation.md` — single IDL-first JSON-RPC major-1 contract, unversioned `protocol/host/` source, generated Rust and safe Desktop TypeScript boundaries, on-demand external TypeScript generation, exact revision/digest admission, atomic replacement, and validation
