...
class EnvironmentProvider:
    ...
    def write_scratch_file(self, filename: str, content: object) -> Awaitable[str]: ...
...
class SqliteSessionStore:
    ...
    def commit_run_evidence(self, commit: object) -> Awaitable[dict[str, object]]: ...
    def commit_checkpoint(self, session_id: str, checkpoint: object) -> Awaitable[None]: ...
    def claim_hitl_resume(self, claim: object) -> Awaitable[None]: ...
    def mark_hitl_resume_started(
        self,
        session_id: str,
        run_id: str,
        claim_id: str,
    ) -> Awaitable[None]: ...
    def release_hitl_resume_claim(
        self,
        session_id: str,
        run_id: str,
        claim_id: str,
    ) -> Awaitable[None]: ...
    def pending_stream_publications(
        self,
        session_id: str,
    ) -> Awaitable[list[dict[str, object]]]: ...
    def acknowledge_stream_publication(
        self,
        publication_id: str,
        target: str,
    ) -> Awaitable[None]: ...
...
def project_stream_records_to_display(
    records: object, session_id: str, run_id: str
