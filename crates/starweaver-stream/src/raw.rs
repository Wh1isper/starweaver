//! Typed raw agent stream protocol.

use std::sync::{Arc, Mutex, PoisonError};

use serde::{Deserialize, Serialize};
use starweaver_core::{
    AgentEvent, AgentExecutionNode, AgentId, ConversationId, Metadata, RunId,
    RunLifecycle as RunStatus, TaskId,
};
...
pub enum AgentStreamEvent {
    ...
    /// A run was cooperatively cancelled after preserving recoverable context state.
    RunCancelled {
        /// Run identifier.
        run_id: RunId,
...
impl starweaver_core::VersionedRecord for AgentStreamRecord {
    const SCHEMA: &'static str = "starweaver.runtime.stream_record";
