//! Checkpointable agent run state shared by execution and durability layers.

use chrono::Utc;
use serde::{Deserialize, Serialize};
use serde_json::Value;
use starweaver_core::{ConversationId, Metadata, RunId, RunLifecycle as RunStatus, TaskId};
