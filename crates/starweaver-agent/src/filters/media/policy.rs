...
pub(super) fn media_policy_from_state_and_context(
    ...
    if policy.max_image_dimension.is_none() && context.model_config.max_image_dimension > 0 {
        policy.max_image_dimension =
            Some(u32::try_from(context.model_config.max_image_dimension).unwrap_or(u32::MAX));
    }
