...
pub mod prelude {
    pub use crate::{
        ...
        AgentStreamResult, CodeActConfig, CodeExecutionLimits, CodeExecutor,
        ComputerUseToolsetPolicy, ContentPart, DynCodeExecutor, DynModelAdapter, FunctionTool,
        ModelSettings, OutputSchema, OutputValue, QuickJsCodeExecutor, RecipeManifest,
        RecipeToolset, RunCodeArgs, TestModel, ToolContext, ToolError, ToolResult,
        attach_codeact_standard_grants, attach_computer_use, attach_guarded_computer_use,
        codeact_tools, computer_use_tools, recipe_tools, typed_tool,
    };
}
...
pub use bundles::{
    ...
    CLARIFYING_ANSWERS_METADATA_KEY, CLARIFYING_QUESTIONS_REQUEST_KIND, CODEACT_TOOLSET_ID,
    ...
    ClarifyingQuestionOption, CodeActConfig, CodeExecutionError, CodeExecutionLimits,
    CodeExecutionRequest, CodeExecutionResult, CodeExecutor, ComputerKeyboardHandle,
    ComputerObserveHandle, ComputerPointerHandle, ComputerToolTimeouts, ComputerUseAdmissionGuard,
    ComputerUseAttachmentError, ComputerUseToolsetPolicy, DEFAULT_SHELL_REVIEW_PROMPT,
    DynCodeExecutor, EnvironmentContextCapability, EnvironmentHandle, HostMediaCapabilities,
    HostMediaUnderstandingClient, HostMediaUnderstandingClientHandle, HostScrapeClient,
    HostScrapeClientHandle, HostSearchClient, HostSearchClientHandle, InputApprovalPolicy,
    MediaUnderstandingRequest, MediaUnderstandingResponse, ProcessShellHandle, QuickJsCodeExecutor,
    ...
    attach_agent_session_control, attach_agent_session_query, attach_codeact_standard_grants,
    attach_computer_use, attach_environment, attach_guarded_computer_use, attach_process_shell,
    attach_shell_review, attach_shell_review_handle, codeact_tools, computer_use_tools,
    ...
    process_shell_toolsets, recipe_tools, resolve_clarifying_question_answers, shell_tools,
    skill_tools, task_tools, user_input_tools,
};
pub use filters::{
...
pub use starweaver_tools::{
    ApprovalRequiredToolset, CodeActEligibility, DeferredToolset, DynTool, DynToolExecutionHook,
    DynToolset, DynamicToolset, EmptyToolArgs, FilteredToolset, FunctionTool, LazyToolset,
    McpPromptSpec, McpResourceSpec, McpSamplingSpec, McpSubscriptionSpec, McpToolSpec, McpToolset,
    McpToolsetConfig, McpTransport, NativeMcpServer, NestedToolError, NestedToolInvoker,
    NestedToolResult, PrefixedTool, PrefixedToolset, PreparedToolset, RenamedToolset,
    StaticToolset, TOOL_METADATA_CONTEXT_MANAGEMENT_KEY, TOOL_METADATA_HIDDEN_BY_TAGS_KEY,
    TOOL_METADATA_KIND_KEY, TOOL_METADATA_SELF_MANAGED_HITL_KEY, TOOL_METADATA_TAGS_KEY,
